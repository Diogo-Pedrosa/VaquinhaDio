...
namespace Vaquinha.Unit.Tests.DomainTests
{
                              ...
                              IClassFixture<CartaoCreditoFixture>
    {
        ...
        {           
            // Arrange
            var doacao = _doacaoFixture.DoacaoValidaComTaxa();
        ...
        [Fact]
        [Trait("Doacao", "Doacao_CorretamentePreenchidos_DoacaoValida_ComTAXA")]
        public void Doacao_CorretamentePreenchidos_DoacaoValida_ComTAXA()
        {
            // Arrange
            var doacaoTaxa = _doacaoFixture.DoacaoValidaComTaxa(false,5,false,true);
            doacaoTaxa.AdicionarEnderecoCobranca(_enderecoFixture.EnderecoValido());
            doacaoTaxa.AdicionarFormaPagamento(_cartaoCreditoFixture.CartaoCreditoValido());

            // Act
            var valido = doacaoTaxa.Valido();

            // Assert
            doacaoTaxa.Valor.Should().Be( 6 , because: "taxa de 20%" );
        ...
        {
            // Arrange
            var doacao = _doacaoFixture.DoacaoValidaSemTaxa(false, 5, false, false);
            doacao.AdicionarEnderecoCobranca(_enderecoFixture.EnderecoValido());
            doacao.AdicionarFormaPagamento(_cartaoCreditoFixture.CartaoCreditoValido());
            ...
            // Assert
            doacao.Valor.Should().Be(5, because: "sem taxa de 20%");
        ...
        public void Doacao_DadosPessoaisInvalidos_DoacaoInvalida()
        {
            ...
            var doacao = _doacaoFixture.DoacaoValidaComTaxa(EMAIL_INVALIDO);
            doacao.AdicionarEnderecoCobranca(_enderecoFixture.EnderecoValido());
            doacao.AdicionarFormaPagamento(_cartaoCreditoFixture.CartaoCreditoValido());
        ...
        {
            // Arrange            
            var doacao = _doacaoFixture.DoacaoValidaComTaxa(false, valorDoacao);
            doacao.AdicionarEnderecoCobranca(_enderecoFixture.EnderecoValido());
            doacao.AdicionarFormaPagamento(_cartaoCreditoFixture.CartaoCreditoValido());
        ...
        public void Doacao_MensagemApoioMaxlenghtExecido_DoacaoInvalida()
        {
            ...
            var doacao = _doacaoFixture.DoacaoValidaComTaxa(false, null, EXCEDER_MAX_LENTH_MENSAGEM_APOIO);
            doacao.AdicionarEnderecoCobranca(_enderecoFixture.EnderecoValido());
            doacao.AdicionarFormaPagamento(_cartaoCreditoFixture.CartaoCreditoValido());
