...
namespace Vaquinha.Tests.Common.Fixtures
{
    ...
    public class DoacaoFixture
    {
        ...
        public Doacao DoacaoValidaComTaxa(bool emailInvalido = false, double? valor = 5, bool maxLenghField = false, bool PagamentoTaxa=true)
        {            
        ...
        public Doacao DoacaoValidaSemTaxa(bool emailInvalido = false, double? valor = 5, bool maxLenghField = false, bool PagamentoTaxa = false)
        {
            var faker = new Faker<Doacao>("pt_BR");
        ...
        public Doacao DoacaoValida(bool emailInvalido = false, double? valor = 5, bool maxLenghField = false)
        {
            ...
            faker.CustomInstantiator(f => new Doacao(Guid.Empty, Guid.Empty, Guid.Empty, valor ?? (double)f.Finance.Amount(MIN_VALUE, MAX_VALUE, DECIMALS),
                                                        PessoaValida(emailInvalido, maxLenghField), null, null,true));
        ...
        public Doacao DoacaoInvalida(bool doacaoAnonima = false)
        {
            ...
            return new Doacao(Guid.Empty, Guid.Empty, Guid.Empty, 0, pessoaInvalida, null, null,true);
        }
