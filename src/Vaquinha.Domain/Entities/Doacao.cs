...
namespace Vaquinha.Domain.Entities
{
    public class Doacao : Entity
    {
        ...
        public Doacao(Guid id, Guid dadosPessoaisId, Guid enderecoCobrancaId, double valor,
                      Pessoa dadosPessoais, CartaoCredito formaPagamento, Endereco enderecoCobranca, bool PagamentoTaxa)
        {
            Id = id;
            ...
            Valor = PagamentoTaxa ? valor * 1.2 : valor; 
        ...
        public bool PagamentoTaxa { get; private set; }
